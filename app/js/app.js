...
const App = {
  ...
  renderCashflow() {
      ...
      <div class="bg-slate-900 text-white rounded-2xl p-4 sm:p-5 mb-5 shadow-xl border border-slate-800">
        ...
        <div class="relative w-full overflow-x-auto scrollbar-thin">
          <div class="min-w-[850px] sm:min-w-full h-72 sm:h-80">
            <canvas id="chartCashflowPlurianual"></canvas>
          </div>
        </div>
      </div>
    `;
    ...
    this.renderCashflowPlurianualChart(labels48, shortLabels48, dataGasto48, dataPartida48);
    if (window.lucide) lucide.createIcons();
  },

  renderCashflowPlurianualChart(labels48, shortLabels48, dataGasto48, dataPartida48) {
    if (this.charts && this.charts.cashflowPlurianual) {
      this.charts.cashflowPlurianual.destroy();
    }

    const canvas = document.getElementById('chartCashflowPlurianual');
    ...
    this.charts.cashflowPlurianual = new Chart(ctx, {
      type: 'line',
      data: {
          ...
          tooltip: {
            ...
            callbacks: {
              ...
              label: (context) => {
                ...
                const fmt = DataStore.formatUSD(val);
              ...
              afterBody: (items) => {
                ...
                if (partida > 0) {
                  if (diff >= 0) {
                    lines.push(` 🟢 Margen Disponible: ${DataStore.formatUSD(diff)}`);
                  } else {
                    lines.push(` 🔴 Desvío Excedido: ${DataStore.formatUSD(Math.abs(diff))}`);
                  }
                }
        ...
        scales: {
          ...
          y: {
            ...
            ticks: {
              color: '#94a3b8',
              font: { size: 10 },
              callback: (val) => DataStore.formatUSD(val)
            },
            beginAtZero: true
          }
        }
        ...
        <div class="border-b-2 border-slate-900 pb-3 mb-4 flex flex-col sm:flex-row sm:items-center justify-between gap-3">
          <div class="flex items-center space-x-3">
            ...
            <div>
              ...
              <h2 class="text-xs font-bold text-blue-900 mt-0.5">Dirección de Infraestructura y Obras • Dirección General</h2>
